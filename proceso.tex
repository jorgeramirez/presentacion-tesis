...
\onslide<1-8>{
\begin{itemize}
    \uncover<1-8>{\item Modelos Ocultos de Markov}
        \begin{itemize}
                \uncover<3-8>{\item Estados: $S$}
                \uncover<4-8>{\item Observaciones: $V$}
                \uncover<5-8>{\item Probabilidad inicial: $\pi$}
                \uncover<6-8>{\item Probabilidad de transici\'on: $a$}
                \uncover<7-8>{\item Probabilidad de observaci\'on: $b$}
        \end{itemize}
    \uncover<8-8>{\item Diccionario Fon\'etico}
\end{itemize}
}
