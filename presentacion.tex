\documentclass[compress,dvipsnames*,svgnames]{beamer}
...
\setbeamertemplate{footline}
{
  ...
  \begin{beamercolorbox}[wd=1\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
    ...
    \insertframenumber{} / \insertpresentationendframe\hspace*{1ex}
  \end{beamercolorbox}}%
  \vskip0pt%
}
...
\title{Dise\~no de una Aplicaci\'on para Composici\'on Musical utilizando Reconocimiento del Habla}
\author{Rodrigo Parra, Jorge Ram\'{i}rez y Mart\'in Abente}

\date{Montevideo, 2014}
